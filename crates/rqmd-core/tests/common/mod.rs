//! Shared test helpers for the `rqmd-core` integration tests.
//!
...
/// RAII snapshot/restore for the env vars rqmd-core reads.
///
...
/// The env vars `paths::rqmd_homedir()` and `paths::config_dir()` consult.
pub const PATH_ENV_KEYS: &[&str] = &["HOME", "USERPROFILE", "RQMD_CONFIG_DIR", "XDG_CONFIG_HOME"];
