...
/// [`crate::prompt::build_qwen3_rerank_prompt`]). The worker returns
...
impl EmbedWorker {
    ...
    /// finished. Used by [`crate::llama_cpp::LlamaCpp::dispose`].
