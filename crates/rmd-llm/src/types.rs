...
/// Options for [`crate::pull::pull_models`].
#[derive(Debug, Clone, Default)]
pub struct PullOptions {
    /// Force re-download even if a cached copy exists.
    pub refresh: bool,
    /// Override the cache directory. None = use [`crate::config::default_model_cache_dir`].
    pub cache_dir: Option<PathBuf>,
}

/// Per-model result from [`crate::pull::pull_models`].
#[derive(Debug, Clone)]
