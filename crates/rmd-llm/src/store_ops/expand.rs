...
use rmd_core::store::cache::{get_cached_result, set_cached_result};
use rmd_core::store::Store;
use serde::{Deserialize, Serialize};

use crate::traits::Llm;
use crate::types::{ExpandQueryOptions, QueryType, Queryable};
...
const _: fn() = || {
    ...
    assert_from::<rmd_core::store::Error>();
    assert_from::<crate::Error>();
};
